...
//
// Unlike other ISR stubs that use the generic isr_with_err_code macro, this stub
// splits user-mode and kernel-mode page faults at the assembly level:
//
...
/// Handles fallible memory operations (e.g., `memcpy_fallible`).
/// Unrecoverable faults result in a panic.
#[unsafe(no_mangle)]
