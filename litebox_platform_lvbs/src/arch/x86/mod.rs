...
/// Enable SSE/XSAVE instruction support in CR0 and CR4.
///
/// This does not configure XCR0. The platform must configure or validate its
/// enabled-state mask before allocating XSAVE buffers or entering user code.
