...
//! OP-TEE SMC call handling — entry point, session management, and message dispatch.
//!
//! This module handles all OP-TEE SMC calls from VTL0, including OpenSession,
//! InvokeCommand, and CloseSession commands.
...
pub(crate) fn optee_smc_handler_entry(smc_args_pfn: u64) -> i64 {
