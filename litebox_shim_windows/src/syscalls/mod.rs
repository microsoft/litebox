...
impl<Platform: RawPointerProvider> SyscallRequest<Platform> {
    pub(crate) fn try_from_raw(pt_regs: &litebox_common_linux::PtRegs) -> Option<Self> {
        ...
        match NtSysno::from_raw(pt_regs.orig_rax)? {
            ...
            NtSysno::NtQueryInformationByName => Some(sys_req!(NtQueryInformationByName {
                object_attributes:*,
                io_status_block:*,
                file_information:*,
                length,
            ...
            NtSysno::NtReadFile => Some(sys_req!(NtReadFile {
                file_handle:{Handle::from_raw},
                event:{Handle::from_raw},
                apc_routine:*,
                apc_context:*,
            ...
            NtSysno::NtOpenKeyEx => Some(sys_req!(NtOpenKeyEx {
                key_handle:*,
                desired_access,
                object_attributes:*,
                open_options,
            ...
            NtSysno::NtNotifyChangeKey => Some(sys_req!(NtNotifyChangeKey {
                key_handle:{Handle::from_raw},
                event:{Handle::from_raw},
                apc_routine:*,
                apc_context:*,
