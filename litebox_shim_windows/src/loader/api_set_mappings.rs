...
const API_SET_MAPPINGS: &[(&str, &str)] = &[
    ...
    ("api-ms-win-dx-d3dkmt-l1-1-9", "gdi32.dll"),
    ...
    (
        "ext-ms-onecore-appmodel-staterepository-appextension-l1-1-0",
        "windows.staterepositoryclient.dll",
    ),
    ("ext-ms-onecore-appmodel-staterepository-cache-l1-1-5", "windows.staterepositorycore.dll"),
    (
        "ext-ms-onecore-appmodel-staterepository-internal-l1-1-7",
        "windows.staterepositoryclient.dll",
    ),
    (
        "ext-ms-onecore-appmodel-staterepository-pkgextension-l1-1-0",
        "windows.staterepositoryclient.dll",
    ),
    ...
    ("ext-ms-onecore-shlwapi-l1-1-1", "shlwapi.dll"),
    ...
    ("ext-ms-win-appmodel-state-ext-l1-1-2", "kernel.appcore.dll"),
    ...
    (
        "ext-ms-win-capabilityaccessmanager-identity-l1-1-0",
        "capabilityaccessmanager.desktop.identity.dll",
    ),
    (
        "ext-ms-win-capabilityaccessmanager-storage-l1-1-0",
    ...
    ("ext-ms-win-ci-management-l1-2-0", "manageci.dll"),
    ...
    ("ext-ms-win-driver-setup-wu-l1-1-2", "drvsetup.dll"),
    ...
    ("ext-ms-win-dx-d3dkmt-dxcore-l1-1-6", "dxcore.dll"),
    ...
    ("ext-ms-win-kernelbase-processthread-l1-2-1", "kernel32.dll"),
    ...
    ("ext-ms-win-reinfo-query-l1-1-1", "reinfo.dll"),
    ...
    ("ext-ms-win-shell-exports-internal-l1-1-2", "shell32.dll"),
    ("ext-ms-win-shell-fileplaceholder-l1-1-0", "windows.fileexplorer.common.dll"),
    ("ext-ms-win-shell-ntshrui-l1-1-1", "ntshrui.dll"),
