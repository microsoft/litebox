...
pub mod syscalls {
    ...
    #[inline]
    pub unsafe fn syscall3(_num: SyscallTable, _arg1: usize, _arg2: usize, _arg3: usize) -> SyscallResult {
        panic!("FreeBSD syscalls are only supported on x86_64 architecture")
    }
    
    #[allow(dead_code)]
    #[inline]
    pub unsafe fn syscall4(_num: SyscallTable, _arg1: usize, _arg2: usize, _arg3: usize, _arg4: usize) -> SyscallResult {
        panic!("FreeBSD syscalls are only supported on x86_64 architecture")
    }
    
    #[allow(dead_code)]
    #[inline]
    pub unsafe fn syscall5(_num: SyscallTable, _arg1: usize, _arg2: usize, _arg3: usize, _arg4: usize, _arg5: usize) -> SyscallResult {
        panic!("FreeBSD syscalls are only supported on x86_64 architecture")
    }
    
    #[allow(dead_code)]
    #[inline]
    pub unsafe fn syscall6(_num: SyscallTable, _arg1: usize, _arg2: usize, _arg3: usize, _arg4: usize, _arg5: usize, _arg6: usize) -> SyscallResult {
        panic!("FreeBSD syscalls are only supported on x86_64 architecture")
    }
}
