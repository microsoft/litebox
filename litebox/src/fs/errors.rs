...
pub enum OpenError {
    ...
    // NOTE: the target can be either relative or absolute; it is simply provides the "raw" target
    // of the symlink.
...
pub enum PathError {
    ...
    DanglingSymlinkExpansion {
        prefix_pre_expansion: alloc::string::String,
        prefix_post_expansion: alloc::string::String,
