...
mod tests {
    ...
    fn identity_signing_private_key_signs_and_verifies_message() {
        ...
        // Use a fixed valid scalar so this unit test only exercises signing and
        // verification; key generation requires a broker-backed random source.
