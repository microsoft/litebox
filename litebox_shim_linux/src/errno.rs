...
impl AsErrno for litebox::fs::errors::PathError {
    fn as_errno(&self) -> i32 {
        match self {
            litebox::fs::errors::PathError::NoSuchFileOrDirectory => ENOENT,
            litebox::fs::errors::PathError::NoSearchPerms { .. } => EACCES,
            litebox::fs::errors::PathError::InvalidPathname => EINVAL,
            litebox::fs::errors::PathError::MissingComponent => ENOENT,
            litebox::fs::errors::PathError::ComponentNotADirectory => ENOTDIR,
        }
    }
}
...
/// Error number constants, generated using
///
/// ```sh
/// for i in $(seq 1 200); do echo $(errno $i) ; done | \
///    awk '/#define/{n=$2; c=$3; $1=""; $2=""; $3=""; print "/// " substr($0,4) "\npub const " n ": i32 = " c ";"}'
/// ```
pub mod constants {
