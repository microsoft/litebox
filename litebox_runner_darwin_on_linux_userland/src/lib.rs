...
/// Run x86-64 macOS (Mach-O) programs with LiteBox on unmodified Linux.
///
...
/// Run a Mach-O program with LiteBox on unmodified Linux, then exit with its
/// status.
///
/// # Errors
///
