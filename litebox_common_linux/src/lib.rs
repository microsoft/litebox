...
const F_DUPFD_CLOEXEC: i32 = F_LINUX_SPECIFIC_BASE + 6;
...
impl<Platform: litebox::platform::RawPointerProvider> core::fmt::Debug for FutexArgs<Platform> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            Self::WAIT {
                addr,
                ...
                .debug_struct("FutexArgs::WAIT")
                .field("addr", &addr.as_usize())
                .field("flags", flags)
                .field("val", val)
                .field("timeout", &timeout.map_or(0, |t| t.as_usize()))
                .finish(),
            Self::WAIT_BITSET {
                addr,
                flags,
                ...
                .debug_struct("FutexArgs::WAIT_BITSET")
                .field("addr", &addr.as_usize())
                .field("flags", flags)
                .field("val", val)
                .field("timeout", &timeout.map_or(0, |t| t.as_usize()))
                ...
                .finish(),
            Self::WAKE { addr, flags, count } => f
                .debug_struct("FutexArgs::WAKE")
                .field("addr", &addr.as_usize())
                .field("flags", flags)
                .field("count", count)
                .finish(),
