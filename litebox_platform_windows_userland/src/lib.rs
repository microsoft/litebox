...
pub struct WindowsUserland {
    ...
    /// Complete native extents acquired by this backend, including unused padding.
...
impl WindowsUserland {
    ...
    /// # Panics
    ///
    /// Panics if the TLS slot cannot be created or the host reservation alignment is unsupported.
    pub fn new() -> &'static Self {
        ...
        assert_eq!(
            ...
            Self::RESERVATION_ALIGNMENT,
            "unsupported host reservation alignment"
        );
...
impl WindowsUserland {
    const RESERVATION_ALIGNMENT: usize = 0x10000;
