...
fn clone_uses_distinct_guest_tls_and_x18_slots() {
    ...
    // on clear_child_tid with FUTEX_WAIT_PRIVATE, then checks its own values are unchanged.
    let code = [
        ...
        0xd2801001, 0xb9400002, 0x340000a2, 0xd2800003, 0xd2800c48, 0xd4000001, 0x17fffff9,
